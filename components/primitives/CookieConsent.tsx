...
export function CookieConsent() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-rule bg-white"
    >
      <div className="mx-auto flex max-w-container flex-col gap-4 px-4 py-5 md:flex-row md:items-center md:justify-between md:px-6">
        <p className="type-body-s max-w-2xl text-midnight/80">
          ...
          you choose.{" "}
          <Link href="/legal/cookies" className="text-blue underline underline-offset-4">
            Cookie policy
          </Link>
        </p>
        <div className="flex shrink-0 gap-3">
          <button
            ...
            className="type-eyebrow border border-blue px-5 py-3 text-blue transition-colors duration-fast ease-brand hover:bg-blue hover:text-sand"
          >
            Reject all
          </button>
          <button
