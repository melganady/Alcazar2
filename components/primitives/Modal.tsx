...
export function Modal({
  ...
  return (
    <dialog
      ...
      className={cn(
        "w-full max-w-lg bg-surface p-0 text-navy backdrop:bg-navy/40",
        className,
      )}
    >
      <div className="flex flex-col gap-5 p-8">
        <div className="flex items-start justify-between gap-6">
          ...
          <button
            ...
            className="type-eyebrow -m-2 p-2 text-navy/80 transition-colors duration-fast ease-brand hover:text-navy"
          >
