  ...
  return (
    <div className={cn("flex flex-col gap-1.5", className)}>
      ...
      <div className="relative">
        <select
          id={id}
          className="type-body w-full appearance-none border border-rule bg-white py-2.5 pe-9 ps-3.5 text-midnight transition-colors duration-fast ease-brand focus:border-blue"
          {...props}
        >
          {options.map((o) => (
