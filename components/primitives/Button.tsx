...
const variants: Record<Variant, string> = {
  primary: "bg-navy text-chalk hover:bg-navy/85",
  secondary:
    "border border-steel text-navy bg-transparent hover:bg-steel/25",
  ghost: "text-navy underline-offset-4 hover:underline underline-offset-4 hover:underline px-2",
};
