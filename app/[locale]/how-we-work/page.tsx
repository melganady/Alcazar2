  ...
  return (
    <div className="mx-auto flex max-w-container flex-col gap-14 px-4 py-12 md:px-6">
      <header className="flex flex-col gap-3">
        ...
        <h1 className="type-display-l text-blue">Most launches do not pass</h1>
      ...
      <section className="flex flex-col gap-6">
        <h2 className="type-display-m text-midnight">The eight tests</h2>
      ...
      <section className="flex flex-col gap-6">
        <h2 className="type-display-m text-midnight">The five stages</h2>
      ...
      <section className="flex flex-col gap-4">
        <h2 className="type-display-m text-midnight">What we publish when a project fails</h2>
        <p className="type-body-l max-w-2xl text-midnight/80">
        ...
        <Link href="/projects" className="type-eyebrow self-start text-blue hover:text-midnight">
          See the shortlist →
        </Link>
      </section>
    </div>
