...
export default async function HowWeWorkPage({
  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-6">
        <h2 className="type-display-m text-iron">The five stages</h2>
      ...
      <section className="flex flex-col gap-4">
        <h2 className="type-display-m text-iron">What we publish when a project fails</h2>
        ...
        <Link href="/projects" className="type-eyebrow self-start text-iron underline-offset-4 hover:underline">
          See the shortlist →
        </Link>
      </section>
      </div>
