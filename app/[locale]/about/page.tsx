...
export const metadata: Metadata = {
  ...
  description:
    "REIN Investment is a UAE off-plan real estate advisory and mortgage consultancy in Dubai, selecting and underwriting pre-construction assets for private investors.",
};
...
export default async function AboutPage({
  ...
  return (
    <>
      <PageHero
        eyebrow="REIN Investment · The house"
      ...
      <section className="grid gap-10 md:grid-cols-2">
        <div className="flex flex-col gap-4">
          <h2 className="type-display-m text-navy">What we do</h2>
        ...
        <div className="flex flex-col gap-4">
          <h2 className="type-display-m text-navy">Who we work with</h2>
          <p className="type-body text-navy/80">
          ...
          <Link href="/careers" className="type-eyebrow self-start text-navy underline-offset-4 hover:underline">
      ...
      <section className="flex flex-col gap-4">
        <h2 className="type-display-m text-navy">The licence</h2>
        <p className="type-body max-w-2xl text-navy/80">
          ...
          DLD-registered escrow account — REIN Investment does not hold client funds.
        </p>
      </section>
      </div>
    </>
