  ...
  return (
    <div className="mx-auto flex max-w-container flex-col gap-14 px-4 py-12 md:px-6">
      <header className="flex flex-col gap-3">
        ...
        <h1 className="type-display-l text-blue">{VERBATIM.tagline}</h1>
        <p className="type-body-l max-w-2xl text-midnight/80">{VERBATIM.positioning}</p>
      </header>

      <section className="grid gap-10 md:grid-cols-2">
        <div className="flex flex-col gap-4">
          <h2 className="type-display-m text-midnight">What we do</h2>
        ...
        <div className="flex flex-col gap-4">
          <h2 className="type-display-m text-midnight">Who we work with</h2>
          <p className="type-body text-midnight/80">
          ...
          <Link href="/careers" className="type-eyebrow self-start text-blue hover:text-midnight">
      ...
      <CropMarks className="self-start">
        <div className="bg-sand p-8">
          <p className="type-display-m max-w-2xl text-midnight">{VERBATIM.theTest}</p>
        </div>
      </CropMarks>

      <section className="flex flex-col gap-4">
        <h2 className="type-display-m text-midnight">The licence</h2>
