...
export default function Error({
  ...
  return (
    <div className="mx-auto flex max-w-container flex-col items-start gap-6 px-4 py-32 md:px-6">
      <p className="type-eyebrow text-navy/80">500</p>
      <h1 className="type-display-l max-w-2xl text-navy">Something broke at our end</h1>
      ...
      {error.digest ? (
        <p className="type-micro text-navy/80">Reference {error.digest}</p>
      ) : null}
