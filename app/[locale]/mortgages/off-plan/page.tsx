...
export default async function OffPlanFinancePage({
  ...
  return (
    <>
      <PageHero
        eyebrow="REIN Investment · Off-plan finance"
      ...
      <section className="grid gap-5 md:grid-cols-2">
        <div className="flex flex-col gap-3 border border-rule bg-surface p-6">
          <p className="type-eyebrow text-navy/80">Stage 1 · During construction</p>
          <h2 className="type-display-s text-navy">Developer instalments, self-funded</h2>
        ...
        <div className="flex flex-col gap-3 border border-rule bg-surface p-6">
          <p className="type-eyebrow text-navy/80">Stage 2 · At handover</p>
          <h2 className="type-display-s text-navy">The mortgage starts — against a valuation</h2>
          <p className="type-body-s text-navy/80">
      ...
      <section className="flex flex-col gap-5">
        <h2 className="type-display-m text-navy">Lenders that finance off-plan during construction</h2>
        {lendersRes.docs.length > 0 ? (
          <ul className="flex max-w-2xl flex-col divide-y divide-rule border border-rule bg-surface">
      ...
      <p className="type-micro max-w-3xl text-navy/80">
        ...
        not guaranteed. REIN Investment acts as an intermediary and is not a lender. Off-plan property
